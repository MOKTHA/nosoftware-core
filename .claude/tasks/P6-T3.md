...
## Context
- Read buildplan.md Phase 6 section for full scope and exit criteria
- Read graphify-out/GRAPH_REPORT.md Session Memory block before touching files
- Current dependency: all P5 tasks must be DONE (verify in LOOP_STATE.json)
...
3. Compare current repo state vs buildplan.md Phase 6 exit criteria
...
## Exit Criteria
See buildplan.md Phase 6 — satisfy ALL checkboxes for this task scope.

## Completion
After ALL exit criteria for this task are met and verifications pass, output:
LOOP_TASK_DONE: P6-T3 | EVIDENCE: <verification output summary> | RISKS: <risks or 'none'>
